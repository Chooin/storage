 ...
 * 是否使用临时属性
 */
Storage.prototype.useTemporary = function (config) {
 ...
 * @param  {Object} config
 */
Storage.prototype.key = function (key, config) {
 ...
 * @param  {Object} config
 */
Storage.prototype.storage = function (config) {
 ...
 * @param  {Object} config
 */
Storage.prototype.pre = function (config) {
  return this.useTemporary(config) && getObjectType(config.pre) === 'String'
         ? config.pre
         : this.defaults.pre
}
 ...
 * @param  {Object} config
 */
Storage.prototype.set = function (key, value, config) {
 ...
 * 清除 storage 值
 */
Storage.prototype.clear = function (config) {
 ...
 * @param  {Object} config
 */
Storage.prototype._set = function (key, value, config) {
  if (isDef(key)) {
    key = this.key(key, config)
    let storage = this.storage(config)
    if (isDef(value)) {
 ...
 * @param  {Object} config
 */
Storage.prototype._remove = function (key, config) {
  if (key) {
